...
This document complements the experimental results of the [paper](https://arxiv.org/abs/2206.07428). 
...
The harmonic mean of the throughputs is the throughput of the mixed workload:
$$
QPS_{mixed} =
\frac{1}{
  f_{ro} / QPS_{ro} +
...
The threshold of duration-only and range-only queries at which these indices are the best varies from dataset to dataset, and depends also on how many range-duration queries are involved[^why-range-duration].
