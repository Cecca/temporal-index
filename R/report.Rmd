...
The figure below confirms this expectation.
...
To further investigate the behavior of the various indices,
...
plays some role, unlike the workload used in the conference version.
...
From the figure above, we see that, compared to the conference version
